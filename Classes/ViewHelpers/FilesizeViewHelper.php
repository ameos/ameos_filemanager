...
class FilesizeViewHelper extends \TYPO3\CMS\Fluid\Core\ViewHelper\AbstractViewHelper {
    ...
    public function getUnit($packOfThree) {
        switch ($packOfThree) {
            case 0:
                return LocalizationUtility::translate('filesizeO', 'ameos_filemanager');
                break;
            case 1:
                return LocalizationUtility::translate('filesizeKO', 'ameos_filemanager');
                break;
            case 2:
                return LocalizationUtility::translate('filesizeMO', 'ameos_filemanager');
                break;
            case 3:
                return LocalizationUtility::translate('filesizeGO', 'ameos_filemanager');
                break;
            case 4:
                return LocalizationUtility::translate('filesizeTO', 'ameos_filemanager');
                break;
            case 5:
                return LocalizationUtility::translate('filesizePO', 'ameos_filemanager');
                break;
            default:
                break;
        }
